...
- **Harness adapters** for Claude, Codex, Cursor, OpenCode, Kiro, Grok Build, and Kilo (see [docs/harness-support.md](docs/harness-support.md) for what each one supports)
